...
resource "aws_vpc" "main" {
  ...
  tags = merge(var.extra_tags_vpc, var.tags, {
    "Name" = var.name
  })
}
...
module "public_nat_subnets" {
  ...
  availability_zones = slice(var.availability_zones, 0, local.nat_gateway_count)
  cidr               = var.cidr_block
...
module "public_lb_subnets" {
  ...
  availability_zones = var.enable_public_lb_subnets ? var.availability_zones : []
  cidr               = var.cidr_block
...
module "private_app_subnets" {
  ...
  availability_zones = var.enable_private_app_subnets ? var.availability_zones : []
  cidr               = var.cidr_block
...
module "private_db_subnets" {
  ...
  availability_zones = var.enable_private_db_subnets ? var.availability_zones : []
  cidr               = var.cidr_block
...
module "private_management_subnets" {
  ...
  availability_zones = var.enable_private_management_subnets ? var.availability_zones : []
  cidr               = var.cidr_block
